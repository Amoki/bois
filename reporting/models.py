...
from vomito.models import Game
...
class ScriptLog(models.Model):
	...
	game = models.ForeignKey(Game, null=True, default=None, on_delete=models.SET_NULL)
	...
	def __unicode__(self):
		return "%s(%s).%s" % (self.object_type, self.object_pk)
